...
const controller = {
    ...
    updateUser: (req, res) => {
        ...
        dbconnection.getConnection(function(err, connection) {
            ...
            // Use the connection
            connection.query(
                `UPDATE user SET firstName = '${firstName}', lastName = '${lastName}', isActive = ${isActive}, emailAdress = '${emailAdress}', password = '${password}', phoneNumber = '${phoneNumber}', street = '${street}', city = '${city}' WHERE id = '${userId}';`,
                function(error, results, fields) {
                    // When done with the connection, release it.
                    connection.release();
